    ...
    public ProjectMonitoringData saveProjectMonitoringData(UUID loanApplicationId) {
        ...
        if (projectMonitoringData == null) {
            ...
            projectMonitoringDataItems.add(projectMonitoringDataItemService
                    .saveProjectMonitoringDataItem(new ProjectMonitoringDataItemResource(null, null, 1, null, "1",
                            "Unit Size", "", "", "", "")));
            projectMonitoringDataItems.add(projectMonitoringDataItemService
                    .saveProjectMonitoringDataItem(new ProjectMonitoringDataItemResource(null, null, 2, null, "2",
                            "Overall Project Cost", "", "", "", "")));
            projectMonitoringDataItems.add(projectMonitoringDataItemService
                    .saveProjectMonitoringDataItem(new ProjectMonitoringDataItemResource(null, null, 3, null, "3",
                            "Debt Equity Ratio", "", "", "", "")));
            projectMonitoringDataItems.add(projectMonitoringDataItemService
                    .saveProjectMonitoringDataItem(new ProjectMonitoringDataItemResource(null, null, 4, null, "4",
                            "Total Debt", "", "", "", "")));
            projectMonitoringDataItems.add(projectMonitoringDataItemService
                    .saveProjectMonitoringDataItem(new ProjectMonitoringDataItemResource(null, null, 5, null, "5",
                            "LEV. Cost of Supply w/o ROE - Total", "", "", "", "")));
            projectMonitoringDataItems.add(projectMonitoringDataItemService
                    .saveProjectMonitoringDataItem(new ProjectMonitoringDataItemResource(null, null, 6, null, "6",
                            "DSCR (MIN)", "", "", "", "")));
            projectMonitoringDataItems.add(projectMonitoringDataItemService
                    .saveProjectMonitoringDataItem(new ProjectMonitoringDataItemResource(null, null, 7, null, "7",
                            "DSCR (MAX)", "", "", "", "")));
            projectMonitoringDataItems.add(projectMonitoringDataItemService
                    .saveProjectMonitoringDataItem(new ProjectMonitoringDataItemResource(null, null, 8, null, "8",
                            "Offtake Volume", "", "", "", "")));
            projectMonitoringDataItems.add(projectMonitoringDataItemService
                    .saveProjectMonitoringDataItem(new ProjectMonitoringDataItemResource(null, null, 9, null, "9",
                            "Offtake Mix", "", "", "", "")));
            projectMonitoringDataItems.add(projectMonitoringDataItemService
                    .saveProjectMonitoringDataItem(new ProjectMonitoringDataItemResource(null, null, 10, null, "10",
                            "Sale Rate", "", "", "", "")));
            projectMonitoringDataItems.add(projectMonitoringDataItemService
                    .saveProjectMonitoringDataItem(new ProjectMonitoringDataItemResource(null, null, 11, null, "11",
                            "Fuel Mix", "", "", "", "")));
            projectMonitoringDataItems.add(projectMonitoringDataItemService
                    .saveProjectMonitoringDataItem(new ProjectMonitoringDataItemResource(null, null, 12, null, "12",
                            "Fuel Cost", "", "", "", "")));
            projectMonitoringDataItems.add(projectMonitoringDataItemService
                    .saveProjectMonitoringDataItem(new ProjectMonitoringDataItemResource(null, null, 13, null, "13",
                            "Construction Period", "", "", "", "")));
            projectMonitoringDataItems.add(projectMonitoringDataItemService
                    .saveProjectMonitoringDataItem(new ProjectMonitoringDataItemResource(null, null, 14, null, "14",
                            "SCOD(3 Revisions)", "", "", "", "")));
