export class EnquiryApplicationRegEx {
    ...
    public static projectCost = /^\d{1,8}(\.\d{1,2})?$/;
    // ** Check comments on projectCost for other variations in the regEx.
    public static equity = /^\d{1,8}(\.\d{1,2})?$/;
    public static projectDebtAmount = /^\d{1,8}(\.\d{1,2})?$/;
    public static pfsDebtAmount = /^\d{1,8}(\.\d{1,2})?$/;
    public static expectedSubDebt = /^\d{1,8}(\.\d{1,2})?$/;
    public static pfsSubDebtAmount = /^\d{1,8}(\.\d{1,2})?$/;
    public static leadFILoanAmount = /^\d{1,8}(\.\d{1,2})?$/;
    public static borrowerNetWorth = /^\d{1,8}(\.\d{1,2})?$/;
    public static borrowerPAT = /^\d{1,8}(\.\d{1,2})?$/;
